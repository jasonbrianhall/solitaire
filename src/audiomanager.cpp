...
// Factory function implementation that creates the appropriate platform-specific player
...
bool AudioManager::loadSoundFromMemory(SoundEvent event, const std::vector<uint8_t>& data, const std::string& format) {
    std::lock_guard<std::mutex> lock(mutex_);
