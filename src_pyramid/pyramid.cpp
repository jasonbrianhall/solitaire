...
void PyramidGame::showHowToPlay() {
  ...
  const char *instructions =
    ...
    "Game Setup:\n"
    "- 28 cards are dealt face-up in a pyramid with 7 overlapping rows\n"
    "- Remaining cards form the draw pile in the upper left\n"
    "- One card from the draw pile is shown at a time in the waste pile\n\n"
    "Rules:\n"
    "1. You can only select cards that are completely uncovered\n"
    ...
    "   - 5 + 8 = 13\n"
    "   - 6 + 7 = 13\n"
    "   - K = 13 (removed on its own)\n"
    "3. You may match a pyramid card with a waste card\n"
    "4. Click the draw pile to reveal the next card\n"
    "5. The game ends when all pyramid cards are removed or no more matches are possible\n\n"
    "Controls:\n"
    "- Left-click cards to select and match\n"
