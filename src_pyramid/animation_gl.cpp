...
bool SpiderGame::validateOpenGLContext() {
...
bool SpiderGame::initializeGLEW() {
...
bool SpiderGame::checkOpenGLCapabilities() {
...
void SpiderGame::explodeCard_gl(AnimatedCard &card) {
    card.exploded = true;
...
void SpiderGame::drawAnimatedCard_gl(const AnimatedCard &anim_card,
...
void SpiderGame::drawCardFragment_gl(const CardFragment &fragment,
...
void SpiderGame::drawWinAnimation_gl(GLuint shaderProgram, GLuint VAO) {
...
void SpiderGame::drawDealAnimation_gl(GLuint shaderProgram, GLuint VAO) {
...
void SpiderGame::drawFoundationAnimation_gl(GLuint shaderProgram, GLuint VAO) {
    if (foundation_move_animation_active_) {
        drawAnimatedCard_gl(foundation_move_card_, shaderProgram, VAO);
    }
}

void SpiderGame::drawStockToWasteAnimation_gl(GLuint shaderProgram, GLuint VAO) {
...
void SpiderGame::drawDraggedCards_gl(GLuint shaderProgram, GLuint VAO) {
...
GLuint SpiderGame::setupCardQuadVAO_gl() {
...
GLuint SpiderGame::setupShaders_gl() {
...
bool SpiderGame::reloadCustomCardBackTexture_gl() {
...
bool SpiderGame::initializeCardTextures_gl() {
...
bool SpiderGame::initializeRenderingEngine_gl() {
    std::cout << "\n" << std::string(70, '=') << std::endl;
...
GLuint SpiderGame::loadTextureFromMemory(const std::vector<unsigned char> &data) {
...
void SpiderGame::drawCard_gl(const cardlib::Card &card, int x, int y, bool face_up) {
    static int count = 0;
...
void SpiderGame::drawFoundationDuringWinAnimation_gl(size_t pile_index, const std::vector<cardlib::Card> &pile, int x, int y) {
...
void SpiderGame::drawNormalFoundationPile_gl(size_t pile_index, const std::vector<cardlib::Card> &pile, int x, int y) {
...
void SpiderGame::drawEmptyPile_gl(int x, int y) {
...
void SpiderGame::highlightSelectedCard_gl() {
...
void SpiderGame::renderFrame_gl() {
